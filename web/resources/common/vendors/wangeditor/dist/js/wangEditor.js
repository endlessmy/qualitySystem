import jquery from 'common/vendors/wangeditor/dist/js/lib/jquery-2.2.1.js';
(function (factory) {
...
_e(function (E, $) {
    ...
    E.fn.currentRange = function (cr){
        // console.log("_rangeData",this._rangeData)
        if (cr) {
            this._rangeData = cr;
        } else {
...
_e(function (E, $) {
    ...
    E.fn.commandHooks = function () {
        ...
        commandHooks.insertHtml = function (html) {
            ...
            var targetElem;
            // console.log('rangeElem',rangeElem)
...
_e(function (E, $) {
    ...
    E.fn.getSelfOrParentByName = function (elem, selector, check) {
        ...
        if($(elem).hasClass('wangEditor-txt')){
            var node;
            for(var i=0;i<elem.childNodes.length;i++){
                if(elem.childNodes[i].nodeType==1){
                    return node = elem.childNodes[i]
                }
            }
            return node;
        }
