    ...
    <div>
        <div class="main-list-row clearfix">
            <div class="breadcrumbs left">
                <span class="list-title">整体得分排名({{ pageData.counts }})</span>
            </div>
        ...
        <el-table
            ...
            <el-table-column
                :render-header="renderBigProjects"
                label="大项目名称"
...
export default {
    ...
    data() {
        return {
            ...
            tableList: [],
            requestParams: {
                type: 'all', // 项目类型，"all"所有大项目，"mine"当前登录用户相关的大项目
    ...
    methods: {
        // 获取大项目列表
        getBigProjectList() {
            api.queryBigProjectLsit({ type: 'all' }).then(res => {
